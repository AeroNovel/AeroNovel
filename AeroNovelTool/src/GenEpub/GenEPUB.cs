        ...
        public static Epub Gen(string dir)
        {
            ...
            foreach (string f in files)
            {
                ...
                if (f.Contains("info.txt"))
                {
                    ...
                    "<p>推荐使用阅读器:<br/>Apple Books<br/>Microsoft Edge(UWP Edge)<br/>Kindle(使用Kindlegen 转换)<br/></p><svg xmlns=\"http://www.w3.org/2000/svg\"><text fill-opacity=\"0.0\">已检测到落后阅读器</text></svg>" +
                    "</div>";
